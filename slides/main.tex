...
\lstset{
  ...
  %basicstyle=\scriptsize\fontfamily{pfr}\fontseries{mc}\selectfont,
  numbers=left,
	language=python,
	frame=single,
	frameround=tttt,
...
\frame{
  \frametitle{Überblick}
  \tableofcontents[pausesections,hidesubsections,firstsection=24]
}
...
\part{Ausgewählte Analyseverfahren: Clustering, Klassifikation, Regression}

\frame[plain,c]{\partpage}

\frame{
  \frametitle{Überblick}
  \tableofcontents[pausesections,hidesubsections,firstsection=28]
}
...
%\frame{
%  \frametitle{Überblick}
%  \tableofcontents[pausesections,hidesubsections,firstsection=32]
%}
