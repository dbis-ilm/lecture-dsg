...
\begin{itemize}
   ...
   %     \item Terme, die in vielen Dokumenten vorkommen, sind weniger aussagekräftig für den Inhalt eines gegebenen Dokumentes
\end{itemize}
\end{itemize}
...
\item Konstruktion einer Vektorrepräsentation für ein Wort durch Nutzung der vielen Kontexte in einem Korpus
    ...
    {\small
    \begin{tabbing}
    \emph{Unter} \fbox{Studium} \emph{wird primär das wissenschaftliche Lernen und Forschen \dots} \\
    \emph{\dots Tipps rund ums} \fbox{Studium} \emph{und zur Studienwahl.} \\
    \emph{Mein} \fbox{Studium} \emph{an der TU Ilmenau \dots}
    \end{tabbing}}
\end{frame}
...
\begin{frame}
    ...
    \includegraphics[width=0.9\linewidth]{fig8/sentiment}
